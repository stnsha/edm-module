 ...
 * Shared JWT transport lives in edm/api-jwt.php - included with API_JWT_INCLUDED
 * so only the helper functions load. Endpoints are added per feature and must be
 * mirrored in edm-api.
 */
