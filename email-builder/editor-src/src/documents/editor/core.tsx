...
import InlineTextEditor from '../blocks/helpers/InlineTextEditor';
...
const EDITOR_DICTIONARY = buildBlockConfigurationDictionary({
  ...
  Button: {
    ...
    Component: (props) => (
      <EditorBlockWrapper>
        <InlineTextEditor selector=":scope > div > a > span" multiline={false}>
          <Button {...props} />
        </InlineTextEditor>
      </EditorBlockWrapper>
    ),
  ...
  Heading: {
    ...
    Component: (props) => (
      <EditorBlockWrapper>
        <InlineTextEditor selector=":scope > h1, :scope > h2, :scope > h3" multiline={false}>
          <Heading {...props} />
        </InlineTextEditor>
      </EditorBlockWrapper>
    ),
  ...
  Text: {
    ...
    Component: (props) => (
      <EditorBlockWrapper>
        <InlineTextEditor selector=":scope > div" multiline>
          <Text {...props} />
        </InlineTextEditor>
      </EditorBlockWrapper>
    ),
